...
const CreateNew = props => {
  ...
  const handleSubmit = e => {
    ...
    props.setNotification(`New anecdote ${e.target.content.value} created`);
    setTimeout(() => {
...
const CreatedNew = withRouter(CreateNew);
    ...
    <Router>
      <div>
        ...
        <Route
          path='/create'
          render={() => (
            <CreatedNew addNew={addNew} setNotification={setNotification} />
          )}
        />
